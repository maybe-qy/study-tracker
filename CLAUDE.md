...
| 优先级 | 方法 | 置信度 |
|--------|------|--------|
| 1 | 双模块换算法（语数英+选科独立换算） | A/B 级 — 需校内升级数据（各科特控线+浙大线） |
| 2 | 分数线对照法（等比例放缩） | A 级 — 需模考特控线 + 高考特控线 |
| 3 | 校排阈值估算法 | B 级 — 校内特控线+浙大线阈值反推排名 |
| 4 | 校内排名对照法 | A 级 — 需本校高考对照表 + 校内排名 |
| 5 | 排名锚定法（交叉验证） | A 级 — 需全市/联盟排名 + 一分一段表 |
| 6 | 校排名估算 | C 级 — 仅校内排名，无对照表 |
